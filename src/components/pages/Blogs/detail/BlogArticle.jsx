                ...
                <div className="row">
                    <div className="blog-stat">
                        <div className="stat-card">
                            <Image src="/assets/icon/stat.svg" width={18} height={18} alt="stat" />
                            <span>views</span>
                            <span>1.6K</span>
                        </div>

                        <div className="stat-card">
                            <Image src="/assets/icon/branch.svg" width={18} height={18} alt="stat" />
                            <span>Shares</span>
                            <span>996K</span>
                        </div>
                    ...
                    <div className="sidebar">
                        <div className="social">
                            ...
                            <div className="social-stats">
                                <div className="social-stats">
                                    <div className="stat">
                                        <Image src="/assets/images/blog/ico/youtube.svg" width={20} height={20} alt="ico" ></Image>
                                        <span>10</span>
                                    </div>

                                    <div className="stat">
                                        <Image src="/assets/images/blog/ico/twitter.svg" width={20} height={20} alt="ico" ></Image>
                                        <span>69k</span>
                                    </div>

                                    <div className="stat">
                                        <Image src="/assets/images/blog/ico/instagram.svg" width={20} height={20} alt="ico" ></Image>
                                        <span>45</span>
                                    </div>

                                    <div className="stat">
                                        <Image src="/assets/images/blog/ico/pinterest.svg" width={20} height={20} alt="ico" ></Image>
                                        <span>69k</span>
                                    </div>
                                    <div className="stat">
                                        <Image src="/assets/images/blog/ico/facebook.svg" width={20} height={20} alt="ico" ></Image>
                                        <span>69k</span>
                                    </div>
